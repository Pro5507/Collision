...
background_image = pygame.transform.scale(pygame.image.load("dowanload (3).jpeg"),(SCREEN_HEIGHT, SCREEN_WIDTH))
...
class Sprite(pygame.sprite.Sprite):
    ...
    def move(self, x_change, y_change):
        self.rect.x = max(min(self.rect.x + x_change, SCREEN_HEIGHT - self.rect.width), 0)
